...
use frontend-design to improve the "selected app" look beautiful. forget about the border staff use absolute position and mark current application with a dot. place it on the top left corner. make it visible
