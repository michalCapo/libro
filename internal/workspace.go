...
//go:embed workspace.css workspace.js voice.js files.js notes.js note-editor.bundle.js
...
func workspaceJS(sid string) string {
	...
	voiceJS, _ := workspaceAssets.ReadFile("voice.js")
